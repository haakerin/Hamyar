...
var Ripple = function() {
    ...
    }, { key: "applyAnimation", value: function applyAnimation(element) { element.animate([{ transform: "scale(0)", opacity: 1 }, { transform: "scale(1.5)", opacity: 0 }], { duration: 500, easing: "linear" }) } }, {
        key: "create",
...
(function setRipple() {
    ...
    if (lightRipple) {
        ...
        try {
            for (var _iterator = lightRipple[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var element = _step.value;
                element.addEventListener("mouseup", function(event) { ripple.create(event, "light") })
            }
        } catch (err) {
    ...
    if (darkRipple) {
        ...
        try {
            for (var _iterator1 = darkRipple[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = true) {
                var element1 = _step1.value;
                element1.addEventListener("mouseup", function(event) { ripple.create(event, "dark") })
            }
        } catch (err) {
            _didIteratorError1 = true;
            _iteratorError1 = err
        } finally { try { if (!_iteratorNormalCompletion1 && _iterator1.return != null) { _iterator1.return() } } finally { if (_didIteratorError1) { throw _iteratorError1 } } }
    }
})();